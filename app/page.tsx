  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-80px)] overflow-hidden">
      ...
      <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center text-center space-y-6 md:space-y-8">
          <WordPullUp 
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl text-foreground font-heading leading-tight md:leading-[1.1]"
          />
          <FadeIn delay={0.6}>
          ...
          <FadeIn delay={0.8} direction="up" className="flex flex-col sm:flex-row items-center gap-4 pt-4 md:pt-8 w-full sm:w-auto">
            <Link 
              href="/services" 
              className="w-full sm:w-auto px-8 py-4 bg-primary text-primary-foreground font-heading font-bold tracking-widest rounded-full transition-all hover:bg-primary/90 hover:scale-105 active:scale-95 shadow-lg shadow-primary/25"
            >
              LEARN MORE
            </Link>
            <Link 
              href="/contact-us" 
              className="w-full sm:w-auto px-8 py-4 bg-transparent border-2 border-foreground text-foreground font-heading font-bold tracking-widest rounded-full transition-all hover:bg-foreground hover:text-background hover:scale-105 active:scale-95"
            >
              CONTACT US
            </Link>
          </FadeIn>
      ...
      <section className="w-full py-20 md:py-32 px-6 lg:px-8 bg-background">
        <div className="max-w-7xl mx-auto">
          <FadeIn>
            <h2 className="text-4xl md:text-5xl font-heading font-bold text-foreground mb-10 md:mb-16 text-center">Our Industries of Expertise</h2>
          </FadeIn>
              ...
              <FadeIn key={industry.title} delay={0.1 * i} className="group relative w-full aspect-[4/3] sm:aspect-square rounded-2xl overflow-hidden cursor-pointer">
                <Link href="/projects" className="block w-full h-full">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-20">
                    <h3 className="text-xl font-heading font-bold text-white text-center px-4">{industry.title}</h3>
                  </div>
                </Link>
              </FadeIn>
            ))}
